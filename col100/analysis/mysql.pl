...
print "<li>The fact that both MTL100 and COL100 show similar correlations with prior-CS-exposure is clear evidence that the correlations are not causal.</li>\n";
print "</ol>\n";
...
print "</li>\n";
print "<li>Finally: if COL100 is made two-step, IMHO we must also advocate MTL100 (and similarly other courses) to also be considered for making two-step in the same breath. Why should this be a COL100 specific issue? Are we concerned about education in general, or is this some selfish exercise of the CS department?</li>\n";
print "</ol>\n";
